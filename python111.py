...
#  .format (degiskenlere süslü parantez içindeki yerler siralamasiyla bastan sona kendini siralar ve deger verir. #

#  süslü parantez içindekilere atadigimiz degiskenlerle eslestirir) #
...
#Input (kullanicidan bir sayi almak için kullanilir)

#Print (kullanirken üçer tirnakli kullanirsaniz arka arkaya yazabilirsiniz alt satirda yazma kolayligi saglar)
